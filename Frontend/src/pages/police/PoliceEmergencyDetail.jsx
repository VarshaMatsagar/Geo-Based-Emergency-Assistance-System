...
import { getEmergencyById, updateEmergencyStatus } from "../../api/policeApi";
import AuthenticatedImage from "../../Components/AuthenticatedImage";

const PoliceEmergencyDetail = () => {
  const { id } = useParams();
  ...
  if (error && !emergency) {
    return (
      <Container className="mt-4">
        ...
        <Button variant="secondary" onClick={() => navigate("/police")}>
          Back to Dashboard
        </Button>
      </Container>
    );
        ...
        <Col md={6} className="mb-4">
          <Card>
            ...
            <Card.Body>
              ...
              <p><strong>Location:</strong> {emergency.address || `${emergency.latitude?.toFixed(4)}, ${emergency.longitude?.toFixed(4)}` || "Not provided"}</p>
              <p><strong>Last Updated:</strong> {emergency.updatedOn ? new Date(emergency.updatedOn).toLocaleString() : "N/A"}</p>
...
export default PoliceEmergencyDetail;